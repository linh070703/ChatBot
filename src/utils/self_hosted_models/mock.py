...
def mock_app(app):
    ...
    def detect_intent_mock():
        ...
        logging.info(f"Raw_intent: {raw_intent}")
        ...
        if intent != 'CANNOT_EXTRACT_INTENT':
            ...
            logging.info(f"Cannot extract intent from the conversation: {raw_intent}")
            return jsonify({
